...
public class PackedMultiArticleQueryBenchmarks
{
    ...
    public void Setup()
    {
        ...
        _query = new PackedMultiArticleQuery(storage);
    ...
    [Benchmark(Description = "Packed: Between query")]
    ...
    [Benchmark(Description = "Packed: Before query")]
    ...
    [Benchmark(Description = "Packed: After query")]
    ...
    [Benchmark(Description = "Packed: Between query + Sum")]
